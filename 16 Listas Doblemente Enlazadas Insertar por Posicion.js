...
// 16 Listas Doblemente Enlazadas Insertar Por Posición
// --------------------------------------------------------

// Insertar por posición.
// a) La posición debe existir

// b) Si es la posición 1, se utilizará el método de insertar que ya existe e inserta en la cabeza

// c) Si es la posición final
//      --> <--Final-->null

//    - El Nuevo nodo su anterior debe apuntar al anterior del nodo final
//    - El Nuevo nodo su siguiente debe apuntar al nodo final
//    - El nodo final el siguiente de su anterior debe apuntar al nvo nodo
//    - El previo de la cola debe apuntar al nuevo nodo

// d) Si es una posición de enmedio
//     -->  <--enMedio-->
//    - El Nuevo nodo su anterior debe apuntar al anterior del nodo actual
//    - El Nuevo nodo su siguiente debe apuntar al nodo actual
//    - El anterior del Nuevo nodo, su siguiente debe apuntar al nuevo nodo
//    - El Nodo actual su anterior debe apuntar al nuevo nodo

// Titulo de la Clase
console.log("AED en JavaScript con NodeJs")
console.log("16 Listas Doblemente Enlazadas Insertar Por Posición")
console.log("")
...
oListaSimple.insertar("Uno",1)
oListaSimple.insertarPorPosicion("Dos",1)
oListaSimple.insertarPorPosicion("Tres",1)
oListaSimple.insertarPorPosicion("Cuatro",1)
oListaSimple.insertarPorPosicion("Cinco",1)
...
// Insertamos en la posicion 5 (MOSTRAR DEBUG)
oListaSimple.insertarPorPosicion("Insertado en 5",5)
...
// Insertamos en la posicion 3
oListaSimple.insertarPorPosicion("Insertado en 3",3)
