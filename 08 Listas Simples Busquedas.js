...
// 08 Listas Simples Búsquedas
// --------------------------------------------------------

// Titulo de la Clase
console.log("AED en JavaScript con NodeJs")
console.log("08 Listas Simples Búsquedas")
console.log("")
...
oListaSimple.insertarAlFinal(20)
oListaSimple.insertarAlFinal(30)
...
// Se busca por posicion
oListaSimple.buscarPorPosicion(2)

// Buscamos un dato mayor
x = oListaSimple.buscarMayor(5)

// Desplegamos el valor resultado
console.log("x[0]:",x[0])
console.log("x[1]:",x[1])

// Buscamos un dato mayor
x = oListaSimple.buscarMayor(95)
...
// Buscamos un dato menor
x = oListaSimple.buscarMenor(5)
